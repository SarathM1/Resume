...
\begin{document}
    ...
    \cvsection{Projects}
        ...
        \cvevent{Natural Language Processing for JIRA ticket Analytics}{}{}{}
            Use NLP and visualisation techniques to allow team members and managers to more effectively manage projects \linebreak
            \begin{itemize}
                \item Data cleaning and Exploratory Data Analysis using NLTK
                    \begin{itemize}
                        ...
                        \item Visualisations using Word Cloud
                    \end{itemize}
                \item Search and filter feature using BERT model and Elasticsearch
                \begin{itemize}
                    \item Converting each ticket into fixed lenght vector using BERT
